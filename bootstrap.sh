...
echo "=== RUNPOD FULL IMAGE ENV SETUP START ==="
...
if [ ! -f "$MODEL_NAME" ]; then
  echo "Downloading Qwen base model..."
...
echo "CivitAI LoRAs ready"

echo "=== RUNPOD FULL IMAGE ENV SETUP COMPLETE ==="
